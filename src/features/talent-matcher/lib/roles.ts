...
export const ROLE_PROFILES: RoleProfile[] = [
  ...
  },
  {
    ...
    primarySkills: ["software engineering", "full stack development", "backend development", "javascript", "typescript", "react", "node.js", "python"],
    secondarySkills: ["java", "spring boot", ".net", "rest api", "postgresql", "next.js", "web development", "microservices", "docker", "aws"],
    titleTiers: [
      ["full stack developer", "fullstack", "application developer", "software engineer", "software developer"],
      ["backend developer", "backend engineer", "python developer", "node developer", "java developer", "engineering manager", "engineering lead", "tech lead", "head of engineering"],
      ["frontend developer", "front end developer", "react developer", "ui engineer", "ai engineer", "ml engineer"],
      ["mobile developer", "android developer", "ios developer", "data engineer", "devops engineer"],
    ],
  },
  {
    key: "full-stack",
