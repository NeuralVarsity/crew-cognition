...
export const SKILL_DICTIONARY: SkillDef[] = [
  ...
  def("testing", "testing", "qa", "quality assurance", "test automation", "unit testing"),
  ...
  def("clickup", "tooling"),
  def("agile", "tooling", "scrum", "kanban", "sprint planning"),
  def("project management", "tooling", "delivery management", "program management"),
  def("figma", "tooling", "ui design", "ux"),
  ...
  def("leadership", "soft", "team lead", "tech lead", "mentoring", "people management"),
